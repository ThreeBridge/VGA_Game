...
set_property DONT_TOUCH true [get_cells <Object/xorrand/randint0__42_carry__5_i_1>]
...
set_false_path -to [get_ports {BTN[*]}]
...
set_property -dict { PACKAGE_PIN R6    IOSTANDARD LVCMOS33 } [get_ports { VGA_HS }]; #IO_L17N_T2_34 Sch=jc_n[3]
set_property -dict { PACKAGE_PIN T6    IOSTANDARD LVCMOS33 } [get_ports { VGA_VS }]; #IO_L17P_T2_34 Sch=jc_p[3]
